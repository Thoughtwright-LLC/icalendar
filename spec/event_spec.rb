...
describe GFIcalendar::Event do
  ...
  describe '#dtstart' do
    ...
    context 'with parent' do
      before(:each) { subject.parent = GFIcalendar::Calendar.new }
    ...
    if defined? ActiveSupport
      describe '#rdate' do
        it 'does not convert a DateTime delegating for an ActiveSupport::TimeWithZone into an Array' do
          ...
          expected = [GFIcalendar::Values::DateTime.new(timestamp)]
  ...
  describe '#to_ical' do
    ...
    context 'complex organizer' do
      before :each do
        subject.organizer = GFIcalendar::Values::CalAddress.new("mailto:jsmith@example.com", cn: 'John Smith')
      end
