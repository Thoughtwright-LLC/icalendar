module GFIcalendar
  ...
  class Alarm < Component
    ...
    required_property :trigger, GFIcalendar::Values::Duration
    required_property :description, GFIcalendar::Values::Text,
                      ->(alarm, description) { alarm.action.downcase == 'audio' || !description.nil? }
    required_property :summary, GFIcalendar::Values::Text,
                      ->(alarm, summary) { alarm.action.downcase != 'email' || !summary.nil? }
    required_multi_property :attendee, GFIcalendar::Values::CalAddress,
    ...
    optional_single_property :repeat, GFIcalendar::Values::Integer
    ...
    optional_single_property :acknowledged, GFIcalendar::Values::DateTime
