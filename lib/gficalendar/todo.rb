module GFIcalendar
  ...
  class Todo < Component
    ...
    optional_single_property :due, GFIcalendar::Values::DateTime
    ...
    optional_single_property :completed, GFIcalendar::Values::DateTime
    ...
    optional_single_property :percent_complete, GFIcalendar::Values::Integer
