...
begin
  ...
  GFIcalendar.logger.info "Could not load tzinfo/data, hopefully tzinfo is accurate (ignore for tzinfo 0.x)"
end
...
module TZInfo
  class Timezone
    def ical_timezone(date, dst = Timezone.default_dst)
      ...
      timezone = GFIcalendar::Timezone.new
  ...
  if defined? TimezoneTransitionInfo
    class TimezoneTransitionInfo
      include GFIcalendar::TimezoneTransition
    end
  else
  ...
  if defined? TimezoneOffsetInfo
    class TimezoneOffsetInfo
      include GFIcalendar::TimezoneOffset
    end
  else
  ...
  class TimezonePeriod
    ...
    def daylight
      ...
      day = GFIcalendar::Timezone::Daylight.new
    ...
    def standard
      ...
      std = GFIcalendar::Timezone::Standard.new
    ...
    def single
      GFIcalendar::Timezone::Standard.new.tap do |std|
