...
begin
  ...
  IcalendarV2.logger.info "Could not load tzinfo/data, hopefully tzinfo is accurate (ignore for tzinfo 0.x)"
end
...
module TZInfo
  class Timezone
    def ical_timezone(date, dst = Timezone.default_dst)
      ...
      timezone = IcalendarV2::Timezone.new
  ...
  if defined? TimezoneTransitionInfo
    class TimezoneTransitionInfo
      include IcalendarV2::TimezoneTransition
    end
  else
  ...
  if defined? TimezoneOffsetInfo
    class TimezoneOffsetInfo
      include IcalendarV2::TimezoneOffset
    end
  else
  ...
  class TimezonePeriod
    ...
    def daylight
      ...
      day = IcalendarV2::Timezone::Daylight.new
    ...
    def standard
      ...
      std = IcalendarV2::Timezone::Standard.new
    ...
    def single
      IcalendarV2::Timezone::Standard.new.tap do |std|
