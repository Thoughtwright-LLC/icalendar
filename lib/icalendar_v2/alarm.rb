module IcalendarV2
  ...
  class Alarm < Component
    ...
    required_property :trigger, IcalendarV2::Values::Duration
    required_property :description, IcalendarV2::Values::Text,
                      ->(alarm, description) { alarm.action.downcase == 'audio' || !description.nil? }
    required_property :summary, IcalendarV2::Values::Text,
                      ->(alarm, summary) { alarm.action.downcase != 'email' || !summary.nil? }
    required_multi_property :attendee, IcalendarV2::Values::CalAddress,
    ...
    optional_single_property :repeat, IcalendarV2::Values::Integer
    ...
    optional_single_property :acknowledged, IcalendarV2::Values::DateTime
